...
dummy_q = Queue(5)
dummy_q.put(1)
collector = Collector(dummy_q, grid_size=grid_size, n_snakes=n_snakes, n_foods=n_foods, unit_size=unit_size, n_obs_stack=n_obs_stack, net=None, n_tsteps=30, gamma=0, env_type=env_type, preprocessor=model.Model.preprocess)
